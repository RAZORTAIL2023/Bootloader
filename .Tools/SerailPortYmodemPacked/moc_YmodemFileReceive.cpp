...
struct qt_meta_stringdata_CLASSYmodemFileReceiveENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSYmodemFileReceiveENDCLASS = QtMocHelpers::stringData(
    "YmodemFileReceive",
    "receiveProgress",
    "",
    "progress",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSYmodemFileReceiveENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject YmodemFileReceive::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_CLASSYmodemFileReceiveENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSYmodemFileReceiveENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSYmodemFileReceiveENDCLASS_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<YmodemFileReceive, std::true_type>,
...
void *YmodemFileReceive::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSYmodemFileReceiveENDCLASS.stringdata0))
